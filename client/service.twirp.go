...
/*
Package main is a generated twirp stub package.
...
func (c *haberdasherProtobufClient) MakeHat(ctx context.Context, in *Size) (*Hat, error) {
	ctx = ctxsetters.WithPackageName(ctx, "twirphp.server_experiment")
...
const HaberdasherPathPrefix = "/twirp/twirphp.server_experiment.Haberdasher/"
